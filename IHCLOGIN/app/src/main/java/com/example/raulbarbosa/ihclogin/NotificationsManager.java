...
public class NotificationsManager {
    ...
    public NotificationsManager(Context context) {
        ...
        this.helloNotification = buildNotification("Detected machine", "Press for more info.");
        this.goodbyeNotification = buildNotification("Bye bye", "good workout");
    }
    ...
    private Notification buildNotification(String title, String text) {
        ...
        return new NotificationCompat.Builder(context, "content_channel")
                ...
                .setContentIntent(PendingIntent.getActivity(context, 0,
                        new Intent(context, Machine.class), PendingIntent.FLAG_UPDATE_CURRENT))
